	...
	public void selectReserve(MemberVO m) {
		...
		try {
			...
			if (rs.next()) {
				...
				mrvNumber.setText(mrn); mrvNumber.setFocusTraversable(false);
				mrvName.setText(m_name); mrvName.setFocusTraversable(false);
				mrvHotel.setText(m_reserve_hotel); mrvHotel.setFocusTraversable(false);
				mrvDate.setText(m_reserve_date); mrvDate.setFocusTraversable(false);
				mrvPhone.setText(m_phone); mrvPhone.setFocusTraversable(false);
				mrvRoom.setText(m_reserve_room); mrvRoom.setFocusTraversable(false);
			}
