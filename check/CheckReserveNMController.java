	...
	public void selectReserve(NonMemberVO nm) {
		...
		try {
			...
			if (rs.next()) {
				...
				nmrvNumber.setFocusTraversable(false);
				nmrvName.setText(nm_name); 
				nmrvName.setFocusTraversable(false);
				nmrvHotel.setText(nm_reserve_hotel);
				nmrvHotel.setFocusTraversable(false);
				nmrvDate.setText(nm_reserve_date);
				nmrvDate.setFocusTraversable(false);
				nmrvPhone.setText(nm_phone);
				nmrvPhone.setFocusTraversable(false);
				nmrvRoom.setText(nm_reserve_room);
				nmrvRoom.setFocusTraversable(false);
			}
