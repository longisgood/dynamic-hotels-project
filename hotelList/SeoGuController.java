...
public class SeoGuController implements Initializable {
	...
	@FXML
	private ImageView BWPhotel, PFhotel, PHhotel;
	...
	public void initialize(URL location, ResourceBundle resources) {
		btncon.setOnAction(e -> {
			...
			if (cb1.isSelected() == true && cb2.isSelected() == false && cb3.isSelected() == false) {
				move("/hotelRoom/SeoGu/BestWesternHotel.fxml", BWPhotel);
			} else if (cb2.isSelected() == true && cb1.isSelected() == false && cb3.isSelected() == false) {
				move("/hotelRoom/SeoGu/PairFieldHotel.fxml", PFhotel);
			} else if (cb3.isSelected() == true && cb2.isSelected() == false && cb1.isSelected() == false) {
				move("/hotelRoom/SeoGu/PineHillHotel.fxml", PHhotel);
			} else {
