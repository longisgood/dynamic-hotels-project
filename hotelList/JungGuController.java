...
public class JungGuController implements Initializable {
	...
	@FXML
	private ImageView ASThotel, CMDhotel, CHhotel;
	...
	public void initialize(URL location, ResourceBundle resources) {
		btncon.setOnAction(e -> {
			...
			if (cb1.isSelected() == true && cb2.isSelected() == false && cb3.isSelected() == false) {
				move("/hotelRoom/JungGu/ASTIHotel.fxml", ASThotel);
			} else if (cb2.isSelected() == true && cb1.isSelected() == false && cb3.isSelected() == false) {
				move("/hotelRoom/JungGu/CommodoreHotel.fxml", CMDhotel);
			} else if (cb3.isSelected() == true && cb2.isSelected() == false && cb1.isSelected() == false) {
				move("/hotelRoom/JungGu/CrownHarborHotel.fxml", CHhotel);
			} else {
