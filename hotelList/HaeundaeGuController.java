...
public class HaeundaeGuController implements Initializable {
	...
	@FXML
	private ImageView GLhotel, LAhotel, PHhotel;
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		btncon.setOnAction(e -> {
			...
			if (cb1.isSelected() == true && cb2.isSelected() == false && cb3.isSelected() == false) {
				move("/hotelRoom/HaeundaeGu/GrandLctHotel.fxml", GLhotel);
			} else if (cb2.isSelected() == true && cb1.isSelected() == false && cb3.isSelected() == false) {
				move("/hotelRoom/HaeundaeGu/LavideAtlanHotel.fxml", LAhotel);
			} else if (cb3.isSelected() == true && cb2.isSelected() == false && cb1.isSelected() == false) {
				move("/hotelRoom/HaeundaeGu/ParkHyattHotel.fxml", PHhotel);
			} else {
