...
public class signUpController implements Initializable {
	@FXML
	private Button btnIdCheck, btnConfirm, btnCancel;
	@FXML
	private TextField textID, textName, textPhone;
	@FXML
	private PasswordField textPW, textPWC;
	@FXML
	private Label IDC, PWC;
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		btnConfirm.setOnAction(e -> {
			if (textID.getText().trim().equals("") || textPW.getText().trim().equals("")
					|| textPWC.getText().trim().equals("") || textName.getText().trim().equals("")
